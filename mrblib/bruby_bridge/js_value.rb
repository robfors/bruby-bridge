module BRubyBridge
  class JSValue
    ...
    def self.array(array_rb = [])
      raise TypeError, "argument must respond to #to_ary" unless array_rb.respond_to?(:to_ary)
      array_rb = array_rb.to_a
    ...
    def self.string(string_rb = "")
      ...
      when string_rb.is_a?(Symbol)
        ...
        raise TypeError, "argument must respond to #to_str or be of type Symbol"
      end
