...
# test("::rb_object")
# # rb objects should be of type RbValue in js environment
# c = Class.new
# ensure_js_result("v0 instanceof BRubyBridge.RbValue", JSValue.rb_object(c))
# ensure_js_result("v0 instanceof BRubyBridge.RbValue", JSValue.rb_object(c.new))
# c = nil
# # passed rb objects should be of correct rb type
# c = Class.new
# vc = JSValue.rb_object(c)
# vi = JSValue.rb_object(c.new)
# ensure_js_result("v1.send('is_a?', v0).to_boolean() == true", vc, vi)
# c, vc, vi = nil
# # passing rb objects of different types shuold not be of same type in js 
# c1 = JSValue.rb_object(Class.new)
# i2 = JSValue.rb_object(Class.new.new)
# ensure_js_result("v1.send('is_a?', v0).to_boolean() == false", c1, i2)
# c1, i2 = nil
# # passing same object again sould result in same RbValue
# c = Class.new
# cc = c.new
# ensure_js_result("v0 === v1", JSValue.rb_object(cc), JSValue.rb_object(cc))
# c, cc = nil
# # passing different object sould result in different RbValue
# c = Class.new
# i1 = JSValue.rb_object(c.new)
# i2 = JSValue.rb_object(c.new)
# ensure_js_result_not("v0 == v1", i1, i2)
# ensure_js_result_not("v0 === v1", i1, i2)
# c, i1, i2 = nil
# # invoke a passed method object
# c = Class.new do
#   def a(n)
#     n + 1
#   end
# end
# m = c.new.method(:a)
# v0 = JSValue.rb_object(m)
# ensure_js_result("v0.send('call', BRubyBridge.RbValue.float(3)).to_number() === 4", v0)
# c, m, v0 = nil
...
#
#ensure_raise(TypeError) { js_eval("4") + 2 }
#
#ensure_raise(TypeError) { 4 + js_eval("2") }
...
#
#ensure_raise(TypeError) { js_eval("3") % 2 }
#
#ensure_raise(TypeError) { 3 % js_eval("2") }
...
#ensure_raise(TypeError) { js_eval('global').call("f", "a") }
# wrong second argument type
#ensure_raise(TypeError) { js_eval('global').call("f", []) }
# wrong second argument type
#ensure_raise(TypeError) { js_eval('global').call("f", nil) }
...
# rescue ec => rb_error
#   ensure_result(js_error.is_a?(ec))
...
# Object.undef_method(:m)
# # pass wrong type
# ensure_raise(TypeError) { js_eval("(class {})").new("2") }
...
# # test("#rb_object?")
# # #
# # ensure_result( js_eval("BRubyBridge.RbValue.Object").rb_object? )
# # #
# # ensure_result( js_eval("BRubyBridge.RbValue.Object.send('new')").rb_object? )
# # #
# # ensure_result( js_eval("BRubyBridge.RbValue.Object.number(2)").rb_object? )
# # #
# # ensure_result_not( js_eval("2").rb_object? )
# # #
# # ensure_result_not( js_eval("true").rb_object? )
# # #
# # ensure_result_not( js_eval("({})").rb_object? )
# # #
# # ensure_result_not( js_eval("'2'").rb_object? )
# # #
# # ensure_result_not( js_eval("undefined").rb_object? )
...
# ensure_raise(TypeError) { js_eval("({})").set("a", "b") }
# # second argument wrong type
# ensure_raise(TypeError) { js_eval("({})").set("a", 3) }
# # too many arguments
...
# # test("#to_rb_object")
# # #
# # ensure_result( js_eval("BRubyBridge.RbValue.Object").to_rb_object.equal?(Object) )
# # #
# # o = js_eval("BRubyBridge.RbValue.Object.send('new')").to_rb_object
# # ensure_result( o.instance_of?(Object) )
# # o = nil
# # #
# # o = js_eval("BRubyBridge.RbValue.Object.send('new')")
# # ensure_result( o.to_rb_object.equal?(o.to_rb_object) )
# # o = nil
# # #
# # ensure_result( js_eval("BRubyBridge.RbValue.Object.number(2)").to_rb_object == 2 )
# # #
# # ensure_raise(TypeError) { js_eval("2").to_rb_object }
# # #
# # ensure_raise(TypeError) { js_eval("({})").to_rb_object }
# # #
# # ensure_raise(TypeError) { js_eval("undefined").to_rb_object }
